...
class AddNewContact(unittest.TestCase):
    ...
    def test_add_new_contact(self):
        ...
        self.open_address_book_entry_page(wd)
        self.create_new_address_book_entry(wd, Contact(last_name="Kolosov", first_name="Petr", middle_name="Sergeevich", nickname="petrucho", company="Ololo",
    ...
    def create_new_address_book_entry(self, wd, contact):
    ...
    def open_address_book_entry_page(self, wd):
